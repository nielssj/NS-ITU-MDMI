...
class Node:
	...
	def makeDotGraph(self, graph, classes, names = None):
		name = self.label
		if(names == None): names = dict()
		...
		for edge in self.children:
			c_node = self.children[edge].makeDotGraph(graph, classes, names)
...
def generateDecisionTree(data, cl):
